...
const styles = {
  ...
  streakBox: { width: 64, height: 64, background: COLORS.card, border: "1px solid #2E2E32", borderRadius: 16, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 4, cursor: "pointer", flexShrink: 0 },
  streakBoxNum: { fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 16, color: COLORS.text },
  statsPillFull: { marginTop: 16, background: COLORS.card, border: "1px solid #2E2E32", borderRadius: 14, display: "flex", alignItems: "center", gap: 8, padding: "14px 16px", cursor: "pointer", color: COLORS.text, fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, fontSize: 14.5 },
  ...
  finishBtn: { width: "100%", background: COLORS.highlight, border: "none", borderRadius: 14, padding: "17px", fontFamily: "'Space Grotesk', sans-serif", fontWeight: 600, fontSize: 16, color: COLORS.bg, display: "flex", alignItems: "center", justifyContent: "center", gap: 8, cursor: "pointer", marginBottom: 8 },
  ...
  sheetBar: { width: "100%", maxWidth: 420, background: COLORS.card, borderRadius: "20px 20px 0 0", padding: "10px 20px 26px", boxSizing: "border-box", animation: "sheetUp 0.25s ease-out", boxShadow: "0 -8px 24px rgba(0,0,0,0.5)", borderTop: "1px solid #2E2E32" },
  ...
  sheetContinueBtn: { width: "100%", background: COLORS.highlight, border: "none", borderRadius: 14, padding: "16px", fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 15, letterSpacing: "0.02em", color: COLORS.bg, cursor: "pointer" },
  ...
  milestoneCircleActive: { width: 50, height: 50, borderRadius: "50%", background: COLORS.card, border: `2px solid ${FLAME}`, boxShadow: `0 0 12px ${FLAME}55`, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", flexShrink: 0, gap: 1, color: FLAME, fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 11 },
  milestoneCircleFuture: { width: 50, height: 50, borderRadius: "50%", border: "1.5px solid #3A3A3E", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", flexShrink: 0, gap: 1, color: COLORS.muted, fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 11 },
