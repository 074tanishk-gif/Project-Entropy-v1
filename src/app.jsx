...
const styles = {
  ...
  streakBox: { width: 64, height: 64, background: COLORS.card, border: "1px solid #2E2E32", borderRadius: 16, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", cursor: "pointer" },
  ...
  addSubjectBtn: { marginTop: 16, background: "none", border: "1px dashed #333336", borderRadius: 12, padding: "13px", color: COLORS.highlight, fontFamily: "Inter, sans-serif", fontSize: 14, display: "flex", alignItems: "center", gap: 8, cursor: "pointer" },
  ...
  sheetContinueBtn: { width: "100%", background: COLORS.highlight, border: "none", borderRadius: 14, padding: "16px", fontFamily: "'Space Grotesk', sans-serif", fontWeight: 700, fontSize: 15, letterSpacing: "0.03em", color: COLORS.bg, cursor: "pointer" },
